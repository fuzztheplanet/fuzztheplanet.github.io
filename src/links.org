...
***** Resources
:PROPERTIES:
:CUSTOM_ID: prog-general-resources
:END:
...
- x86asm.net's [[http://ref.x86asm.net/index.html][reference]]
- Félix Cloutier's [[https://www.felixcloutier.com/x86/][instruction reference]]
- [[https://syscall.sh/][syscall.sh]] Linux syscall reference on various architectures
- [[https://www.azeria-labs.com][Azeria Labs]]'s detailed ARM assembly tutorials and ref card
...
:PROPERTIES:
:CUSTOM_ID: sec-general-multi-topic
:END:
...
:PROPERTIES:
:CUSTOM_ID: sec-recon-subdomains
:END:
...
:PROPERTIES:
:CUSTOM_ID: sec-windows-pentest
:END:

- [[https://riccardoancarani.github.io/2019-10-04-lateral-movement-megaprimer/][Lateral Movement Megaprimer]].
- [[https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Active%20Directory%20Attack.md][Attacking Active Directory (PayloadAllTheThings)]] by [[https://github.com/swisskyrepo][Swisskey]].
...
- [[https://ohshitgit.com][Oh Shit, Git!?!]] are tips to troubleshoot yourself out of bad situations
...
- [[https://seanthegeek.net/459/demystifying-dmarc/][Demistifying DMARC]] is an intro to SPF, DKIM and DMARC
